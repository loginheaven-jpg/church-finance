...
const menuSections: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/reports/weekly', label: '주간 요약', icon: FileText, minRole: 'deacon' },
      { href: '/reports/monthly', label: '연간 요약', icon: BarChart3, minRole: 'deacon' },
      { href: '/reports/comparison', label: '연간 비교', icon: Scale, minRole: 'deacon' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/cash-offering-entry', label: '헌금함 입력', icon: Wheat, minRole: 'admin' as const },
